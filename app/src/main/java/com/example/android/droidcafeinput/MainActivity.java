...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Register the donut image with the context menu for long press actions
        ImageView donutImageView = (ImageView) findViewById(R.id.donut);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_order:
                displayToast("Order choice selected");
                return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_order:
                Intent openOrderActivityIntent = new Intent (this, OrderActivity.class);
                openOrderActivityIntent.putExtra(EXTRA_MESSAGE, mOrderMessage);
                startActivity(openOrderActivityIntent);
                return true;
